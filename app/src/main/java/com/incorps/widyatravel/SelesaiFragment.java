...
public class SelesaiFragment extends Fragment {
    ...
    private static String URL_DIPESAN_IT = "http://widyatravel.000webhostapp.com/api/api_dapat_individual_trip_selesai.php";
    private static String URL_DIPESAN_CR = "http://widyatravel.000webhostapp.com/api/api_dapat_car_rent_selesai.php";
